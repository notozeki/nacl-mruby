...
SOURCES = plugin.c ppb_interface.c mruby_interface.c
...
.PHONY: mruby-make
mruby-make:
	@echo -n Building mruby...
	@diff ./build_config.rb $(MRUBY)/build_config.rb > /dev/null || \
	  cp $(MRUBY)/build_config.rb $(MRUBY)/build_config.rb.orig &&  \
	  cp ./build_config.rb $(MRUBY)/build_config.rb
	@cd $(MRUBY); make > /dev/null
	@echo done.
